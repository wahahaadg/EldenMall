...
import com.zxc.websocket.WebSocketServer;
...
@RestController
@RequestMapping("/pay")
@Api(value = "提供关于支付相关的接口", tags = "支付管理管理")
@CrossOrigin
public class PayController {
    ...
    public String paySuccess(HttpServletRequest request) throws Exception {
        ...
        if(map!=null && success.equalsIgnoreCase(map.get(resultCode))){
            //支付成功
            //2.修改订单状态为“待发货/已支付”
            ...
            //4.响应微信支付平台
            if(i>0){
                HashMap<String,String> resp = new HashMap<>(8);
